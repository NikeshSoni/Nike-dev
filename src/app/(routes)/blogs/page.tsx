  ...
  return (
    <div className="p-4 sm:p-6 max-w-4xl mx-auto">
      ...
      <p className="text-sm sm:text-base mb-4 text-gray-700 leading-relaxed">
        ...
        My subsequent role as a <strong>Pre-Authorization Analyst at Infinx Pvt Ltd</strong> 
      ...
      <ul className="list-disc list-inside text-sm sm:text-base mb-4 space-y-3 text-gray-700">
        ...
        <li className="leading-relaxed">
          <strong>Collaborative Document Editor ✍️</strong><br />
          Built a Google Docs-inspired application featuring real-time collaboration using Next.js, Convex DB, and Tiptap editor, 
          with secure authentication via Clerk Auth.
        </li>
        <li className="leading-relaxed">
          <strong>Additional Technical Demonstrations 🧪</strong>:
          <ul className="list-disc list-inside ml-6 mt-1 space-y-1">
            <li>🍎 Apple Website Clone (Responsive UI Implementation)</li>
            <li>🎨 Portfolio Website for Creative Professional</li>
            <li>🚗 E-commerce Interface for Automotive Brand</li>
            <li>📱 Mobile Accessories E-commerce Platform</li>
          </ul>
        </li>
      </ul>
